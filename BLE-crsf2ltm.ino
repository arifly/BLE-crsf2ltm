...
// 0 aus - ltm bridge   1 ein - copy only
#define CRSF_BRIDGE 0
...
#define ESP32_Variant 1 //heltec
//#define ESP32_Variant 2 //wemos
...
//    Serial.println((char*)pData);
    //Serial.write(*pData);
      ...
      //crossfire_encodeTargetData(pData)
      if (millis() - previousMilliscb >= anzeigeupdate) {
        previousMilliscb = millis();
        send_LTM();
        #if defined(DEBUG)
          Serial.println("sendLTM");
        #endif
      }
...
void setup() {
  ...
  //Serial2.println("Tadaa AriTrans Ready");
  // SDA, SCL
  //Wire.begin(4, 15);
  //Wire.begin(5, 17);
  Wire.begin(SDA, SCL);
